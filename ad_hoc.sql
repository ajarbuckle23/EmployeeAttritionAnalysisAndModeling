...
# What are the stats for overtime, performance rating, and job satisfaction for each job role? 
...
# What are the stats for overtime, performance rating, and job satisfaction for each education field? 
# CONDITION: Round figures to 2 decimal places
SELECT
	EducationField,
	ROUND(100 * (SUM(CASE WHEN OverTime = 'Yes' THEN 1 ELSE 0 END) / COUNT(*)), 2) AS 'Percentage of Employees who Work Overtime',
